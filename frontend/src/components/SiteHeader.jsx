  ...
  return (
    <>
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-50">
        <div className="max-w-[1600px] mx-auto px-4 lg:px-8 py-2 lg:py-3 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center">
            <img 
              src="/logo.png" 
              alt="Power Flow Logo" 
              className="h-10 lg:h-12 w-auto object-contain scale-[2.5] origin-left ml-2" 
            />
          </Link>
